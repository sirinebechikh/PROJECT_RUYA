...
@Component({
  selector: 'app-prelevement20',
  templateUrl: './prlv20.html',
  styleUrls: ['./prlv20.scss'],
  standalone: true,
  imports: [CommonModule, FormsModule],
})
export class Prelevement20Component implements OnInit, OnDestroy {
  fichiers: Fichier[] = [];
  ...
  ngOnInit() {
    this.subscription = this.ajouterFichierService.fichiers$.subscribe(data => {
      this.fichiers = (data || []).filter(f => f.typeFichier === 'prelevement' && f.codeValeur === '20');
      this.applyFilters();
